...
public class NorthCommand extends MovementCommand {
    public NorthCommand(MessageSender messageSender, RoomManager roomManager, RoomActions roomActions) {
        super(messageSender, roomManager, roomActions, "North", "north", "South");
    }
}
